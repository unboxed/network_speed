...
This is a tool developed during one of Unboxed's hackathon session. It can be used to measure the internet speed on your router. If you have multiple routers in the office, this can plot them on a chart and show you which one is the fastest.
