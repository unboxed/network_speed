...
This is a tool that can be used to measure the internet traffic on your router. If you have multiple routers in the office, this can plot them on a chart and show you which one is the fastest.
